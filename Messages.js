...
export default class MessageScreen extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity style={[styles.logout]} onPress={Actions.ProfileScreen}>
        {BackButton}
        </TouchableOpacity>
        <TouchableOpacity style={[styles.trash]} onPress={Actions.ProfileScreen}>
        {TrashIcon}
        </TouchableOpacity>
        <TouchableOpacity style={[styles.reminder]} onPress={Actions.ProfileScreen}>
        {ReminderIcon}
        </TouchableOpacity>
        </View>
        <ScrollView>
          <View style={[styles.content]}>
            <View style={[styles.box3]}>
                        ...
                        <Text style={[styles.userP]}>Reunion de codominio 28 de Agosto</Text>
  ...
  <View style={[styles.boxFooterIcons]}>{AddressIconf}</View>
        ...
        <TouchableOpacity style={[styles.boxf,styles.boxc0, styles.boxFooter]} onPress={Actions.ProfileScreen}>
...
const WriteIcon = (<Icon name="pencil-square-o" size={26} color="#ddd"/>);
